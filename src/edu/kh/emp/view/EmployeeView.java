...
public class EmployeeView {
	...
	public void printAll(List<Employee> empList) {
		...
		if(empList.isEmpty()) {
			...
			System.out.println("사번    |   이름      | 주민등록번호    |          이메일         |    전화번호   |     부서   | 직책  |   급여   ");
			System.out.println("--------------------------------------------------------------------------------------------------------");
	...
	public void insertEmployee() {
		...
		// 수행 후 테이블에 반영된 행의 개수를 반홤함
		
		if(result > 0 ) { //DML 구문 성공시
			System.out.println("사원 정보 추가 성공");
		} else {  //DML 구문 실패시
			System.out.println("사원 정보 추가 성공 실패");
		}
	...
	public void selectSalaryEmp() {
		...
		System.out.println("<입력 받은 급여이상을 받는 모든 사원 정보 조회>");
